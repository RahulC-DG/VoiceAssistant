...
import { Download, Mic, Zap, X } from "lucide-react"
...
export function Hero() {
  ...
  return (
    <>
      {/* Announcement Banner */}
      {showBanner && (
        <div className="bg-gradient-to-r from-[#1f6feb] to-[#ff6b35] text-white py-3 px-4 relative">
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-2 text-sm">
              ...
              >
                Download, extract, and start speaking! 🎤✨
              </a>
            </div>
            <button
